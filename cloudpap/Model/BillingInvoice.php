...
class BillingInvoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => 'string',
        'proforma' => 'string',
        'invoice_entries' => '\Cloudpap\Client\Model\DocumentEntry[]',
        'total' => 'string',
        'total_in_transaction_currency' => 'string',
        'transactions' => '\Cloudpap\Client\Model\BillingTransaction[]'
    ];
    ...
    public function setSeries($series)
    {
        if (!is_null($series) && (mb_strlen($series) > 20)) {
            throw new \InvalidArgumentException('invalid length for $series when calling BillingInvoice., must be smaller than or equal to 20.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $number when calling BillingInvoice., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($number) && ($number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $number when calling BillingInvoice., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSalesTaxName($sales_tax_name)
    {
        if (!is_null($sales_tax_name) && (mb_strlen($sales_tax_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $sales_tax_name when calling BillingInvoice., must be smaller than or equal to 64.');
        }
    ...
    {
        $allowedValues = $this->getTransactionCurrencyAllowableValues();
        if (!in_array($transaction_currency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'transaction_currency', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @return \Cloudpap\Client\Model\DocumentEntry[]
     */
     ...
     *
     * @param \Cloudpap\Client\Model\DocumentEntry[] $invoice_entries invoice_entries
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param \Cloudpap\Client\Model\BillingTransaction[] $transactions transactions
     *
     * @return $this
     */
