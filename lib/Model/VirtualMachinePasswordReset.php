...
/**
 * VirtualMachinePasswordReset Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VirtualMachinePasswordReset implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VirtualMachinePasswordReset';
    ...
    public function setRootPassword($root_password)
    {
        ...
        if (!is_null($root_password) && (mb_strlen($root_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $root_password when calling VirtualMachinePasswordReset., must be bigger than or equal to 1.');
        }
