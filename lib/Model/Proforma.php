 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Proforma implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Proforma';
    ...
    protected static $swaggerTypes = [
        ...
        'state' => 'string',
        'invoice' => 'string',
        'proforma_entries' => '\Swagger\Client\Model\DocumentEntry[]',
        'total' => 'string',
    ...
    protected static $setters = [
        ...
        'state' => 'setState',
        'invoice' => 'setInvoice',
        'proforma_entries' => 'setProformaEntries',
        'total' => 'setTotal',
    ...
    protected static $getters = [
        ...
        'state' => 'getState',
        'invoice' => 'getInvoice',
        'proforma_entries' => 'getProformaEntries',
        'total' => 'getTotal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['proforma_entries'] = isset($data['proforma_entries']) ? $data['proforma_entries'] : null;
    ...
    public function setSeries($series)
    {
        if (!is_null($series) && (mb_strlen($series) > 20)) {
            throw new \InvalidArgumentException('invalid length for $series when calling Proforma., must be smaller than or equal to 20.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $number when calling Proforma., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($number) && ($number < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $number when calling Proforma., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSalesTaxName($sales_tax_name)
    {
        if (!is_null($sales_tax_name) && (mb_strlen($sales_tax_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $sales_tax_name when calling Proforma., must be smaller than or equal to 64.');
        }
    ...
    /**
     * Gets proforma_entries
     *
     * @return \Swagger\Client\Model\DocumentEntry[]
     */
    public function getProformaEntries()
    {
        return $this->container['proforma_entries'];
    }

    /**
     * Sets proforma_entries
     *
     * @param \Swagger\Client\Model\DocumentEntry[] $proforma_entries proforma_entries
     *
     * @return $this
     */
    public function setProformaEntries($proforma_entries)
    {
        $this->container['proforma_entries'] = $proforma_entries;
