...
/**
 * VirtualMachineChangeBackupTemplate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VirtualMachineChangeBackupTemplate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VirtualMachineChangeBackupTemplate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backup_template'] === null) {
            $invalidProperties[] = "'backup_template' can't be null";
        }
