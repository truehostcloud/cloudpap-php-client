...
class Plan implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'private' => 'bool',
        'product_code' => 'string',
        'metered_features' => '\Swagger\Client\Model\MeteredFeature[]',
        'provider' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'generate_after' => 'setGenerateAfter',
        'enabled' => 'setEnabled',
        'private' => 'setPrivate',
        'product_code' => 'setProductCode',
        'metered_features' => 'setMeteredFeatures',
    ...
    protected static $getters = [
        ...
        'generate_after' => 'getGenerateAfter',
        'enabled' => 'getEnabled',
        'private' => 'getPrivate',
        'product_code' => 'getProductCode',
        'metered_features' => 'getMeteredFeatures',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['generate_after'] = isset($data['generate_after']) ? $data['generate_after'] : null;
        ...
        $this->container['metered_features'] = isset($data['metered_features']) ? $data['metered_features'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['interval_count'] > 4294967295)) {
            $invalidProperties[] = "invalid value for 'interval_count', must be smaller than or equal to 4294967295.";
        }
        ...
        if (!is_null($this->container['trial_period_days']) && ($this->container['trial_period_days'] > 4294967295)) {
            $invalidProperties[] = "invalid value for 'trial_period_days', must be smaller than or equal to 4294967295.";
        }
        ...
        if (!is_null($this->container['generate_after']) && ($this->container['generate_after'] > 4294967295)) {
            $invalidProperties[] = "invalid value for 'generate_after', must be smaller than or equal to 4294967295.";
        }

        if (!is_null($this->container['generate_after']) && ($this->container['generate_after'] < 0)) {
            $invalidProperties[] = "invalid value for 'generate_after', must be bigger than or equal to 0.";
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Plan., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
     ...
     * Sets interval
     *
     * @param string $interval The frequency with which a subscription should be billed.
     *
     * @return $this
     */
     ...
     * Sets interval_count
     *
     * @param int $interval_count The number of intervals between each subscription billing
     *
     * @return $this
     */
    public function setIntervalCount($interval_count)
    {
        ...
        if (($interval_count > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling Plan., must be smaller than or equal to 4294967295.');
        }
        if (($interval_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $interval_count when calling Plan., must be bigger than or equal to 0.');
        }
     ...
     * Sets amount
     *
     * @param string $amount The amount in the specified currency to be charged on the interval specified.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency The currency in which the subscription will be charged.
     *
     * @return $this
     */
     ...
     *
     * @param int $trial_period_days Number of trial period days granted when subscribing a customer to this plan.
     *
     * @return $this
     */
    public function setTrialPeriodDays($trial_period_days)
    {
        ...
        if (!is_null($trial_period_days) && ($trial_period_days > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $trial_period_days when calling Plan., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($trial_period_days) && ($trial_period_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $trial_period_days when calling Plan., must be bigger than or equal to 0.');
        }
     ...
     * @return int
     */
    public function getGenerateAfter()
    {
        return $this->container['generate_after'];
    }

    /**
     * Sets generate_after
     *
     * @param int $generate_after Number of seconds to wait after current billing cycle ends before generating the invoice. This can be used to allow systems to finish updating feature counters.
     *
     * @return $this
     */
    public function setGenerateAfter($generate_after)
    {

        if (!is_null($generate_after) && ($generate_after > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $generate_after when calling Plan., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($generate_after) && ($generate_after < 0)) {
            throw new \InvalidArgumentException('invalid value for $generate_after when calling Plan., must be bigger than or equal to 0.');
        }

        $this->container['generate_after'] = $generate_after;
     ...
     * Sets enabled
     *
     * @param bool $enabled Whether to accept subscriptions.
     *
     * @return $this
     */
     ...
     * Sets private
     *
     * @param bool $private Indicates if a plan is private.
     *
     * @return $this
     */
    ...
    /**
     * Gets metered_features
     *
     * @return \Swagger\Client\Model\MeteredFeature[]
     */
    public function getMeteredFeatures()
    {
        return $this->container['metered_features'];
    }

    /**
     * Sets metered_features
     *
     * @param \Swagger\Client\Model\MeteredFeature[] $metered_features metered_features
     *
     * @return $this
     */
    public function setMeteredFeatures($metered_features)
    {
        $this->container['metered_features'] = $metered_features;
