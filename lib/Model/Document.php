...
class Document implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['series']) && (mb_strlen($this->container['series']) < 1)) {
        ...
        if (!is_null($this->container['sales_tax_name']) && (mb_strlen($this->container['sales_tax_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'sales_tax_name', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setKind($kind)
    {
        ...
        if (!is_null($kind) && (mb_strlen($kind) < 1)) {
            throw new \InvalidArgumentException('invalid length for $kind when calling Document., must be bigger than or equal to 1.');
        }
    ...
    public function setSeries($series)
    {
        ...
        if (!is_null($series) && (mb_strlen($series) < 1)) {
            throw new \InvalidArgumentException('invalid length for $series when calling Document., must be bigger than or equal to 1.');
        }
    ...
    public function setSalesTaxName($sales_tax_name)
    {
        ...
        if (!is_null($sales_tax_name) && (mb_strlen($sales_tax_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sales_tax_name when calling Document., must be bigger than or equal to 1.');
        }
